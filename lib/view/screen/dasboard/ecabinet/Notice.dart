...
import 'package:mp_mla_up/view/screen/dasboard/ecabinet/row_view_notice.dart';
import '../../../../utils/alertbox.dart';
import '../../../../utils/size_config.dart';
import '../../../../utils/uri.dart';
import '../../../../view_model/ecabinet_notice_model.dart';
  ...
  Future getAllMad() async {
    ...
    try {
      var url = Uri.parse(URI_API().api_url_ecabinet +
          'getCurrentMeeting?userid=anil.rajbhar@gov.in');
      ...
      if (statuscode == 200) {
        ...
        data = tagObjs
            .map((tagJson) => EcabinetNoticeModel.fromJson(tagJson))
            .toList();
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('आगामी बैठकों की जानकारी',
                                style: TextStyle(
