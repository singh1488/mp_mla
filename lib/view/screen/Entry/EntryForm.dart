...
import 'FinancialAid.dart';

class EntryForm extends StatefulWidget {
  //static const String routeName1 = '/entry_form';

  EntryForm({Key key, this.title}) : super(key: key);
        ...
        Expanded(
          child: PageView(
            ...
            children: <Widget>[
              ...
              Container(color: Colors.white, child: BeneficiaryDetails()),
              Container(color: Colors.white, child: ApplicationDetails()),
              Container(color: Colors.white, child: FinancialAid()),
            ],
          ),
        )
      ],
