...
class AppTheme {
  ...
  static const Color blueAccent = Color(0xFF21BD16);

  static final ThemeData lightTheme = ThemeData(
      primaryColor: selectedTabBackgroundColor,
  ...
  static final TextStyle _titleLight = TextStyle(
    color: Colors.black,
    fontSize: 3.5 * SizeConfig.textSize,
  );
  ...
  static final TextStyle _buttonLight = TextStyle(
    color: Colors.black,
    fontSize: 2.5 * SizeConfig.textSize,
  );

  static final TextStyle _greetingLight = TextStyle(
    color: Colors.black,
    fontSize: 2.0 * SizeConfig.textSize,
  );
